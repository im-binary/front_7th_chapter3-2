                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (value === '' || /^\d+$/.test(value)) {
                          onProductFormChange({ ...productForm, price: value === '' ? 0 : parseInt(value) });
                        }
                      }}
                      onBlur={(e) => {
                        const value = e.target.value;
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const value = e.target.value;
                        if (value === '' || /^\d+$/.test(value)) {
                          onProductFormChange({ ...productForm, stock: value === '' ? 0 : parseInt(value) });
                        }
                      }}
                      onBlur={(e) => {
                        const value = e.target.value;
                      ...
                      <div key={index} className="flex items-center gap-2 bg-gray-50 p-2 rounded">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            onProductFormChange({ ...productForm, discounts: newDiscounts });
                          }}
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => onCouponFormChange({ ...couponForm, code: e.target.value.toUpperCase() })}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const value = e.target.value;
                          if (value === '' || /^\d+$/.test(value)) {
                            onCouponFormChange({ ...couponForm, discountValue: value === '' ? 0 : parseInt(value) });
                          }
                        }}
                        onBlur={(e) => {
